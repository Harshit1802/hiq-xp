...
class PatientEmergencyContactDetailsValidation {
    ...
    public validatePatientRepresentativeContactDetailId(patientRepresentativeContactDetailId: string): boolean {
        return Regex.DEMOGRAPHICSID.test(patientRepresentativeContactDetailId)
    }
}

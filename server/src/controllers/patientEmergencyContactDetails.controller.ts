...
class PatientEmergencyContactDetailsController implements IController {
    ...
    private createEmergencyContactDetails = async (
        ...
        try {
            ...
            const patientRepresentativeContactDetailIdValidated = this.validate.validatePatientRepresentativeContactDetailId(obj.patientRepresentativeContactDetailId)
            if (!patientRepresentativeContactDetailIdValidated) {
                return next(
                    new HttpException(
                        HttpCode.CONFLICT,
            ...
            logger.info(`username ${obj.patientRepresentativeContactDetailId} is valid`)
